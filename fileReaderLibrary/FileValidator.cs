...
namespace fileReaderLibrary
{
    ...
    {   
        public static List<FileExtension> EncryptedFileExtensions = new List<FileExtension> {FileExtension.TXT, FileExtension.XML, FileExtension.JSON};
        public static List<FileExtension> RoleBasedSecuredFileExtensions = new List<FileExtension> {FileExtension.XML, FileExtension.TXT, FileExtension.JSON};
